...
@section('hr-content')
            ...
            <div id="tab-dashboard" class="tab-pane">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="bg-gradient-to-r from-blue-500 to-blue-400 text-white rounded-xl p-5 shadow hover:shadow-lg transition">
                        <p class="text-sm opacity-90">Total Employees</p>
                        <h2 class="text-3xl font-bold mt-1">{{ $totalEmployees ?? 125 }}</h2>
                    </div>

                    <div class="bg-gradient-to-r from-green-500 to-green-400 text-white rounded-xl p-5 shadow hover:shadow-lg transition">
                        <p class="text-sm opacity-90">Active Employees</p>
                        <h2 class="text-3xl font-bold mt-1">{{ $activeEmployees ?? 118 }}</h2>
                    </div>

                    <div class="bg-gradient-to-r from-pink-500 to-pink-400 text-white rounded-xl p-5 shadow hover:shadow-lg transition">
                        <p class="text-sm opacity-90">Late Today</p>
                        <h2 class="text-3xl font-bold mt-1">{{ $lateToday ?? 4 }}</h2>
                    </div>

                    <div class="bg-gradient-to-r from-indigo-500 to-indigo-400 text-white rounded-xl p-5 shadow hover:shadow-lg transition">
                        <p class="text-sm opacity-90">Present Today</p>
                        <h2 class="text-3xl font-bold mt-1">{{ $presentToday ?? 110 }}</h2>
                    </div>

                    <div class="bg-gradient-to-r from-teal-500 to-cyan-400 text-white rounded-xl p-5 shadow hover:shadow-lg transition">
                        <p class="text-sm opacity-90">Attendance %</p>
                        <h2 class="text-3xl font-bold mt-1">{{ $attendancePercentage ?? 0 }}%</h2>
                    </div>

                    <div class="bg-gradient-to-r from-yellow-500 to-amber-400 text-white rounded-xl p-5 shadow hover:shadow-lg transition">
                        <p class="text-sm opacity-90">On Leave</p>
                        <h2 class="text-3xl font-bold mt-1">{{ $onLeave ?? 6 }}</h2>
                    </div>

                    <div class="bg-gradient-to-r from-gray-500 to-gray-400 text-white rounded-xl p-5 shadow hover:shadow-lg transition">
                        <p class="text-sm opacity-90">Archived Employees</p>
                        <h2 class="text-3xl font-bold mt-1">{{ $archivedEmployees ?? 0 }}</h2>
                    </div>

                    <div class="bg-gradient-to-r from-violet-500 to-purple-400 text-white rounded-xl p-5 shadow hover:shadow-lg transition">
                    ...
                    <div class="bg-gradient-to-r from-rose-500 to-red-400 text-white rounded-xl p-5 shadow hover:shadow-lg transition">
                ...
                <div class="bg-white rounded-xl p-6 shadow mt-8">
                    ...
                    <div class="relative h-64">
                        <canvas id="chartPerformance" style="display: block; box-sizing: border-box; height: 256px; width: 902.4px;" width="1128" height="320"></canvas>
                    </div>
