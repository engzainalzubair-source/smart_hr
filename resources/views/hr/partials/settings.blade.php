...
@section('hr-content')
    ...
    <div class="bg-white p-6 rounded-xl shadow-md mt-6">
        ...
        <form id="profileForm" class="space-y-4" method="POST" action="{{ route('hr.settings.profile') }}">
            ...
            <div class="flex items-center gap-3">
                <button id="saveProfileBtn" type="submit" class="px-4 py-2 bg-green-600 text-white rounded">حفظ
                    الملف</button>
        ...
        <form id="passwordForm" class="space-y-4" method="POST" action="{{ route('hr.settings.password') }}">
            ...
            <div class="flex items-center gap-3">
                <button id="savePasswordBtn" type="submit" class="px-4 py-2 bg-red-600 text-white rounded">تغيير كلمة
                    المرور</button>
