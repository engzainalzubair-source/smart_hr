@if(request()->ajax() || request()->query('inline'))
    <div class="p-4">
        <h2 class="text-lg font-semibold mb-4">Add Performance Report</h2>
        <form id="ajaxForm" method="POST" action="{{ route('hr.performances.store') }}">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="date" name="period_start" lang="en" class="w-full p-2 border rounded">
                </div>
                <div>
                    <label>Period End</label>
                    <input type="date" name="period_end" lang="en" class="w-full p-2 border rounded">
                </div>
                <div>
                    <label>Score</label>
