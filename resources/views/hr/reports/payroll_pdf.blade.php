...
<head>
    <meta charset="utf-8">
    <title>{{ config('app.name') }} — Payroll Report</title>
    <style>
...
<body>
    <div class="header">
        <h2>{{ config('app.name') }} — Payroll Report</h2>
        <div class="small">Period: {{ $year }} / {{ $month }} &nbsp; &nbsp; Generated at: {{ \Carbon\Carbon::now()->format('Y-m-d H:i:s') }}</div>
    </div>
